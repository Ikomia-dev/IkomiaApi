...
#ifndef CVIDEOOFTASK_H
#define CVIDEOOFTASK_H
 ...
 * @brief The CVideoOFTask class is derived from CVideoTask and is dedicated to optical flow task based on OpenCV framework.
 ...
 */
class DATAPROCESSSHARED_EXPORT CVideoOFTask :  public CVideoTask
{
    public:
        ...
        CVideoOFTask();
        /**
         * @brief Constructs CVideoOFTask with the given name.
         * Same inputs and outputs as C2dImageTask.
         * @param name: name of the task.
         */
        CVideoOFTask(const std::string& name);

        virtual ~CVideoOFTask() = default;
