...
void exposeFeatureIO(const std::string& className)
{
    ...
    class_<CFeatureProcessIOWrap<Type>, bases<CProtocolTaskIO>, std::shared_ptr<CFeatureProcessIOWrap<Type>>>(className.c_str(), _featureProcessIODocString, init<>("Default constructor"))
...
BOOST_PYTHON_MODULE(pydataprocess)
{
    ...
    //----- CGraphicsInput -----//
    //--------------------------//
    class_<CGraphicsInputWrap, bases<CProtocolTaskIO>, std::shared_ptr<CGraphicsInputWrap>>("CGraphicsInput", _graphicsInputDocString, init<>("Default constructor"))
    ...
    //----- CImageProcessIO -----//
    //---------------------------//
    class_<CImageProcessIOWrap, bases<CProtocolTaskIO>, std::shared_ptr<CImageProcessIOWrap>>("CImageProcessIO", _imageProcessIODocString, init<>("Default constructor"))
    ...
    //----- CVideoProcessIO -----//
    //---------------------------//
    class_<CVideoProcessIOWrap, bases<CImageProcessIO>, std::shared_ptr<CVideoProcessIOWrap>>("CVideoProcessIO", _videoProcessIODocString, init<>("Default constructor"))
    ...
    //----- CWidgetOutput -----//
    //-------------------------//
    class_<CWidgetOutputWrap, bases<CProtocolTaskIO>, std::shared_ptr<CWidgetOutputWrap>>("CWidgetOutput", _widgetOutputDocString, init<>("Default constructor"))
    ...
    //----- CPathIO -----//
    //-------------------//
    class_<CPathIO, bases<CProtocolTaskIO>, std::shared_ptr<CPathIO>>("CPathIO", _pathIODocString)
        .def(init<>("Default constructor")[incref_return_value_policy<>()])
        ...
        .def("clearData", &CPathIO::clearData, _clearDataDocString, args("self"))
    ;
    ...
    class_<CDnnTrainProcessParamWrap, bases<CProtocolTaskParam>, std::shared_ptr<CDnnTrainProcessParamWrap>>("CDnnTrainProcessParam", _dnnTrainProcessParamDocString)
        ...
        .add_property("epochs", &CDnnTrainProcessParam::getEpochCount, &CDnnTrainProcessParam::setEpochCount, "Number of epochs")
        .add_property("classes", &CDnnTrainProcessParam::getClassCount, &CDnnTrainProcessParam::setClassCount, "Number of output classes")
        .add_property("learning_rate", &CDnnTrainProcessParam::getLearningRate, &CDnnTrainProcessParam::setLearningRate, "Learning rate")
        .add_property("momentum", &CDnnTrainProcessParam::getMomentum, &CDnnTrainProcessParam::setMomentum, "Training momentum")
        .add_property("weight_decay", &CDnnTrainProcessParam::getWeightDecay, &CDnnTrainProcessParam::setWeightDecay, "Weight decay")
        .add_property("model_name", &CDnnTrainProcessParam::getModelName, &CDnnTrainProcessParam::setModelName, "DNN model name")
