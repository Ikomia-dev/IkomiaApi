...
target.path = ../Build/Lib/Python/ikomia/dataprocess
INSTALLS += target

LIBS += $$link_python()

pyDataProcessFiles.path = ../Build/Lib/Python/ikomia/dataprocess
pyDataProcessFiles.files += ../Python/dataprocess/__init__.py
INSTALLS += pyDataProcessFiles
